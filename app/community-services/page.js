...
export const metadata = {
  title: 'Community Services | Hightower & Hightower, P.A.',
  description: 'Discover the community services offered by the Law Office of Daniel L. Hightower, P.A. We are committed to supporting local initiatives and making a positive impact.',
};

export default async function Page() {
  const c = await getSectionContent('community-service');
  return (
