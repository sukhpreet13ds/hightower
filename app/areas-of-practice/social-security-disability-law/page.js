...
export const metadata = {
  title: 'Ocala Social Security Disability Lawyer | Hightower & Hightower',
  description: 'Learn about Social Security Disability Law and how to get the benefits you deserve. Our experienced attorneys in Ocala can help you with your claim.',
};
    ...
    <main className="main-content">
      ...
      <section className="detail-area-of-practice-law">
        ...
        <div className="practice-law-container">
          <div className="partners-row">
            <div className="partners-image-col">
              <img src="../assets/Mark.N.jpg" alt="Daniel L. Hightower & Alison L. Hightower"
          ...
          <div className="claims-cards-row">
            <div className="claim-card">
              <img src="../assets/soc1.jpg" alt="Doctor Contact Info" className="claim-card-img" />
              <div className="claim-card-title">Doctor Names & Addresses</div>
            </div>
            <div className="claim-card">
              <img src="../assets/soc2.jpg" alt="15-Year Work History" className="claim-card-img" />
              <div className="claim-card-title">15-Year Work History</div>
            </div>
            <div className="claim-card">
              <img src="../assets/soc3.jpg" alt="Names & Dosages" className="claim-card-img" />
              <div className="claim-card-title">Medications & Dosages</div>
            </div>
            <div className="claim-card">
              <img src="../assets/soc4.jpg" alt="Apply Online" className="claim-card-img" />
              <div className="claim-card-title">Apply Online (SSA.gov)</div>
            </div>
            <div className="claim-card">
              <img src="../assets/soc5.avif" alt="Apply by Phone" className="claim-card-img" />
              <div className="claim-card-title">Apply by Phone (1-800-772-1213)</div>
            </div>
          </div>
        ...
        <div className="products-liability-banner">
          <div className="banner-image-half" style={{ backgroundImage: "url('../assets/soc-wheel.jpg')" }}>
          </div>
          <div className="banner-text-half">
            <div className="banner-text-content">
              ...
              <p style={{ marginLeft: '20px', fontWeight: '500', color: '#dae1e8', marginBottom: '8px' }}>• A letter
                from your church leader, describing observed problems (such as decreased participation or
                visible physical strain/pain).</p>
              <p style={{ marginLeft: '20px', fontWeight: '500', color: '#dae1e8', marginBottom: '8px' }}>• A letter
                from volunteer organizations detailing why you are no longer able to participate due to your
                condition.</p>
              <p style={{ marginLeft: '20px', fontWeight: '500', color: '#dae1e8', marginBottom: '8px' }}>• A letter
                from a friend or neighbor detailing activity level or mood/personality changes (like
                reactive depression).</p>
              <p style={{ marginLeft: '20px', fontWeight: '500', color: '#dae1e8', marginBottom: '8px' }}>• School
                records showing academic difficulty or poor performance.</p>
              <p style={{ marginLeft: '20px', fontWeight: '500', color: '#dae1e8', marginBottom: '20px' }}>• A report
                from a vocational rehabilitation agency finding that you are not a candidate for retraining.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="practice-law-container" style={{ marginBottom: '80px' }}>
          ...
          <div
            ...
            <div
              style={{ backgroundColor: '#f8f9fa', padding: '25px', borderLeft: '4px solid #dc3545', borderRadius: '4px' }}>
              <h4
                style={{ fontFamily: 'var(--family-sans)', fontWeight: '700', color: '#dc3545', marginTop: '0', marginBottom: '10px' }}>
                Generalization (Less Effective)</h4>
              <p
                style={{ fontFamily: 'var(--family-sans)', fontSize: '16px', color: '#555', lineHeight: '1.6', margin: '0' }}>
                <strong>No Details:</strong> Bob and I used to go fishing together all the time, but now his
                back hurts so much that we almost never go fishing anymore.
              </p>
            </div>
            <div
              style={{ backgroundColor: '#f8f9fa', padding: '25px', borderLeft: '4px solid #28a745', borderRadius: '4px' }}>
              <h4
                style={{ fontFamily: 'var(--family-sans)', fontWeight: '700', color: '#28a745', marginTop: '0', marginBottom: '10px' }}>
                Specific Details (Highly Credible)</h4>
              <p
                style={{ fontFamily: 'var(--family-sans)', fontSize: '16px', color: '#555', lineHeight: '1.6', margin: '0' }}>
                <strong>Details:</strong> Bob and I have been fishing buddies for more than ten years. We
                used to spend nearly every Saturday fishing in area lakes and streams. However, since he
                hurt his back last year, we have only been fishing together two or three times. The last
                time was a few months ago. Bob looked miserable when I picked him up in the morning. He was
                stiff and walked very slowly. When we got to the lake, I had to do all the work getting the
                boat in the water. Even though it was a clear calm day, Bob’s back pain was so bad that he
                had to catch his breath every time a small wake rocked the boat. We only fished for an hour
                before Bob couldn’t stand it anymore. He had to lay down in the bottom of the boat as we
                made our way to shore and I had to help him get from the boat to my truck. I haven’t been
                able to get Bob to go fishing with me since then.
              </p>
            </div>
          </div>
