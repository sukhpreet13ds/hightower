...
export default async function Page({ params }) {
  ...
  if (!post) {
    post = isNum
      ? await get('SELECT * FROM news WHERE (slug = ? OR id = ?) AND published = 1', [slug, Number(slug)])
      : await get('SELECT * FROM news WHERE slug = ? AND published = 1', [slug]);
  }
    ...
    <main className="main-content">
      <style dangerouslySetInnerHTML={{
        ...
        @media (max-width: 1024px) {
            ...
            .lawyer-hero-right { max-width: 100%; }
        }
        ...
        <div className="honors-container">
          ...
          <div className="honors-logos-row">
            <div className="honors-logos-track">
              ...
              <div className="honor-logo-item">
                <a href="https://www.bbb.org/us/fl/ocala/profile/personal-injury-lawyers/hightower-hightower-p-a-0733-235974524/#sealclick" target="_blank" rel="nofollow noreferrer">
                  <img src="/assets/bbb-logo.png" alt="Hightower & Hightower, P.A. BBB Accredited Business" style={{ border: 0 }} />
                </a>
              </div>
